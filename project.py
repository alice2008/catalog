...
CLIENT_JSON_FILENAME = '/home/grader/catalog/client_secrets.json'
CLIENT_ID = json.loads(open(CLIENT_JSON_FILENAME, 'r').read())['web']['client_id']

file_handler = logging.FileHandler(filename='/var/log/apache2/catalog.error')
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(CLIENT_JSON_FILENAME, scope='')
